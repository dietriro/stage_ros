...
public:
    ...
    // Service callback for soft reset
    bool cb_step_srv(std_srvs::Empty::Request& request, std_srvs::Empty::Response& response);
...
bool
StageNode::cb_step_srv(std_srvs::Empty::Request& request, std_srvs::Empty::Response& response)
{
  ROS_INFO("Stepping the Simulation!");
...
StageNode::SubscribeModels()
{
    ...
    // advertising reset & step service
    reset_srv_ = n_.advertiseService("/stage/reset_positions", &StageNode::cb_reset_srv, this);
    step_srv_ = n_.advertiseService("/stage/step", &StageNode::cb_step_srv, this);
